...
if ($_GET['act'] == "tambah") {
    ...
    $kelas = "-";
    $alamat = "-";
    $terakhir_login = date('d-m-Y H:i:s');
    

    $query = "INSERT INTO user(kode_user,nis,fullname,username,password,kelas,alamat,verif,role,join_date,terakhir_login)
        VALUES('" . $kode_user . "','" . $nis . "','" . $fullname . "','" . $username . "','" . $password . "','" . $kelas . "','" . $alamat . "', '" . $verif . "','" . $role . "','" . $join_date . "','" . $terakhir_login . "')";
