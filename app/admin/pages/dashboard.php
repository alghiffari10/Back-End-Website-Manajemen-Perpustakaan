...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="row">
            ...
            <h2 class="text-center" style="font-family: Quicksand, sans-serif;">Perpustakaan SMAN 1 Pulau Panggung</h2>
            <p class="text-center">Alamat : Jl. Penantian, Kec. Pulau Panggung, Kabupaten Tanggamus, Lampung</p>
