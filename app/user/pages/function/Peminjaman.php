...
if ($_GET['aksi'] == "pinjam") {
    ...
    if ($_POST['judulBuku'] == NULL) {
        ...
        if ($cek > 0) {
            ...
            $sql = "INSERT INTO peminjaman(nama_anggota,judul_buku,tanggal_peminjaman,tanggal_pengembalian,kondisi_buku_saat_dipinjam,kondisi_buku_saat_dikembalikan,denda)
            VALUES('" . $nama_anggota . "','" . $judul_buku . "','" . $tanggal_peminjaman . "','" . $tanggal_pengembalian . "','" . $kondisi_buku_saat_dipinjam . "','" . $kondisi_buku_saat_dikembalikan . "','" . $denda . "')";
    ...
    $judul_buku = $_POST['judulBuku'];
    $tanggal_pengembalian = $_POST['tanggalPengembalian'];
    $kondisi_bukuSaat_dikembalikan = $_POST['kondisiBukuSaatDikembalikan'];
    ...
    $query = "UPDATE peminjaman SET tanggal_pengembalian = '$tanggal_pengembalian', kondisi_buku_saat_dikembalikan = '$kondisi_bukuSaat_dikembalikan', denda = '$denda' WHERE id_peminjaman = $id_peminjaman";
